    ...
    <div id='home' className='grid min-h-[90vh] grid-cols-2 mx-auto max-w-screen-xl'>
        <div className='flex ml-20 flex-col font-poppins text-2xl font-bold gap-6 justify-center'>
            ...
            <div className='flex gap-3'>
                ...
                {socialLinks.mail &&
                    <div className={`hover:bg-red-500 bg-black text-cyan-500 w-12 h-12 transition-all aspect-square justify-center items-center hover:text-white flex rounded-full`}><SiGmail/></div>
                }
            </div>
        </div>
