...
const About = ({ userInfo }) => {
  return (
    ...
    >
      <div className="font-poppins font-extrabold text-4xl flex gap-3 mb-5">
        <MdPerson />{" "}
        <span>
        ...
        <div className="text-xl w-2/3 gap-3 flex flex-col font-semibold font-poppins">
          ...
          {userInfo?.gDriveResumeLink && (
            <div
              ...
              className="cursor-pointer font-semibold text-base bg-black justify-center items-center rounded-xl text-white flex w-32 text-center gap-2 py-3"
            >
              <FaDownload /> Resume
            </div>
          )}
