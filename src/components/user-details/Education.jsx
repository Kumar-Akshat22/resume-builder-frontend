    ...
    <div className="w-full p-5 mt-6">
      <div className="max-w-[1140px] mx-auto">
        <div className="w-full flex justify-between items-center mb-5">
          <p className="text-xl">Your Educational Details most recent first</p>
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex gap-5 align-items-center justify-center">
            <label className="w-[50%]">
              <span className="text-[17px] font-medium">Institution</span>
              <input
                type="text"
                name="schoolName"
            ...
            <label className="w-[50%]">
              <span className="text-[17px] font-medium">City</span>
              <input
                type="text"
                name="city"
          ...
          <div className="flex gap-5 align-items-center justify-center">
            <label className="w-[50%]">
              <span className="text-[17px] font-medium">Degree</span>
              <select
                className="w-full focus:outline-none focus:border-[#3983fa] focus:ring-1 focus:ring-[#3983fa] border p-[8px] rounded-[0.2rem] mt-1"
                name="degree"
                onChange={handleChange}
            ...
            <label className="w-[50%]">
              <span className="text-[17px] font-medium">Field of Study</span>
              <input
                type="text"
                name="fieldOfStudy"
          ...
          <div className="flex gap-5 align-items-center justify-center">
            <label className="w-[50%]">
              <span className="text-[17px] font-medium">Grade</span>
              <select
                className="w-full focus:outline-none focus:border-[#3983fa] focus:ring-1 focus:ring-[#3983fa] border p-[8px] rounded-[0.2rem] mt-1"
                name="grade"
            ...
            <label className="w-[50%]">
              <span className="text-[17px] font-medium">Marks</span>
              <input
                type="text"
                name="marks"
                ...
                educations.map((education) => (
                  ...
                  <div key={education.id} className='w-full p-5 border rounded-[14px] flex flex-col gap-5 transition-all duration-300 hover:shadow-md'>
                    <div className='w-full flex items-center justify-between'>
                      <div>
                        <h1 className='font-semibold text-lg'>{education.data?.degree + " " + education.data?.fieldOfStudy}</h1>
