...
function BulletPoint( { id, text , deletePoint, updatePoint } ) {

    const [pointInputText , setPointInputText] = useState(text);

    console.log('Inside Bullet Points Component');
    console.log(pointInputText);
  ...
  return (
    <div className='flex items-center gap-5'>
        ...
        <div className='cursor-pointer' onClick={()=>updatePoint(id, pointInputText)}>
            <MdEdit />
        </div>
